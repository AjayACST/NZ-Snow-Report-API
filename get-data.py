...
async def treblecone(session):
    ...
    if data_tc["data"][40] == "No trails are currently groomed.":
        ...
        "main_street_groomed": "No data avilable.",
        ...
        "motatapu_chutes_status": data_tc["data"][37],
        "summit_slopes_status": data_tc["data"][39],
        "main_street_groomed":data_tc["data"][41],
        "easy_rider_groomed": data_tc["data"][43],
        "nice_n_easy_grommed": data_tc["data"][45],
        "raffils_run_grommed": data_tc["data"][47],
        "petes_treat_groomed": data_tc["data"][49],
        "south_ridge_wide_guid": data_tc["data"][51],
        "tims_table_groomed": data_tc["data"][53],
        "high_street_groomed": data_tc["data"][55],
        "saddle_track_groomed": data_tc["data"][57],
        "road_status": data_tc["data"][59],
        "chain_status": data_tc["data"][61],
        "bar_status": data_tc["data"][63],
        "grab_and_go_status": data_tc["data"][65],
        "the_southern_bbq": data_tc["data"][67],
        "allpress_at_altitude": data_tc["data"][69],
        }
